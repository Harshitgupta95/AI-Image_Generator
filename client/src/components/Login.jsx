...
export const Login = () => {
    ...
    const {setShowLogin, backendUrl, setToken, setUser,setIsLoggedIn} = useContext(AppContext)
    ...
    return (
        <div className='fixed top-0 left-0 right-0 bottom-0 backdrop:blur-sm bg-black/30 flex justify-center items-center z-50'>
            ...
            className='relative bg-white p-10 rounded-xl text-slate-500'>
                ...
                <button className='bg-blue-600 w-full text-white py-2 rounded-full tracking-wide'>{state === 'Login' ? 'Login' : 'Create Account'}</button>
