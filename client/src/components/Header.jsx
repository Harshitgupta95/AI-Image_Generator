...
export const Header = () => {
  ...
  return (
    ...
    >
        ...
        <motion.h1 className='text-4xl max-w-[300px] sm:text-5xl sm:max-w-[590px] mx-auto mt-10 text-center'>Turn Text to <span 
        initial={{opacity:0}}
        animate={{opacity:1}}
        transition={{delay:0.4, duration:2}}        
        className='text-blue-700'>Image,</span> in Seconds.</motion.h1>
        ...
        <motion.button className='sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2.5 flex rounded-full gap-2 items-center'
        ...
        className='mt-2 text-neutral-600'>Generated images from Imaginity</motion.p>
    </motion.div>
  )
}
